...
function PointDetail({ point_no }) {
  const navigate = useNavigate();
  const [auth] = useAuth();

  const [{ data: point, loading, error }, refetch] = useApiAxios(
    {
  ...
  return (
    <div>
      ...
      <div className="flex justify-end">
        {point?.user_id?.user_id === auth.user_id && !auth.is_superuser && (
          <>
            <button
            ...
            <Link
              to={`/point_management/${point_no}/edit/`}
              type="button"
